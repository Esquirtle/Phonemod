 ...
 *
 * <p>Paths are relative to the game's asset root, as required by
 * {@code UICommandBuilder.append()} and {@code UICommandBuilder.clear()}.
 *
 * <p>Image paths inside {@code .ui} files are resolved relative to the
...
public final class PhoneAssetPaths {
    ...
    /** The home screen app-launcher grid. */
    public static final String APP_MENU_UI = "Pages/Phone/AppMenu.ui";
